...
Removing unnecessary things like the voice over part of a characters name to *hopefully* match them to the "data" dataset and classify races as good or evil.
```{r}
